...
var RSimulation_Mode = {
    ...
    slot_BidAsk_KrwCoin: [40, 40, 40, 40, 40, 40, 40, 40, 40, 40],
    ...
    target_BidAsk_Ratio: 1.5,            //* The ratio of reverse liquidation margin in each slot. (unit : %)
    ...
    new_addBidAsk_Create_Ratio: 18,       //* The gap of last transaction price to create new add_ask. (unit : %, always minus value)
    new_addBidAsk_Create_Ratio_adj: 0.1, //* The adjustment ratio of new_addbid_crcond. (unit : %, always minus value)
...
var EOS_Small_Gap1 = {
    ...
    real_test_mode: false,
    check_period: 15,           //* The price check duration of main loop, unit is second. (unit : Sec)
    slot_BidAsk_KrwCoin: [30, 30, 30, 30, 30, 30, 30, 30, 30, 30],
    //    slot_1st_Ask_Coin: 50,   //* fisrt investment coint (unit : EA)
    //    slot_2nd_Ask_Coin: 100,  //* after 1st slot, investment coin (unit : EA)
    max_slot_cnt: 30,          //* The limitation number of creating slots (unit : EA) 
    max_addBidAsk_cnt: 4,        //* The max count of additional purchase crypto currency to lower average price on each slot. (slot�� ��Ÿ�� �ִ� ȸ��)
...
var EOS_Middle_Gap1 = {
    ...
    real_test_mode: false,
    check_period: 15,           //* The price check duration of main loop, unit is second. (unit : Sec)
    slot_BidAsk_KrwCoin: [60, 60, 60, 60, 60, 60, 60, 60, 60, 60],
    //    slot_1st_Ask_Coin: 50,   //* fisrt investment coint (unit : EA)
    //    slot_2nd_Ask_Coin: 100,  //* after 1st slot, investment coin (unit : EA)
    max_slot_cnt: 30,          //* The limitation number of creating slots (unit : EA) 
    max_addBidAsk_cnt: 4,        //* The max count of additional purchase crypto currency to lower average price on each slot. (slot�� ��Ÿ�� �ִ� ȸ��)
    target_BidAsk_Ratio: 2.0,            //* The ratio of reverse liquidation margin in each slot. (unit : %)
    target_BidAsk_Ratio_adj: 0.1,        //* The adjustment ratio of target_rate
    new_slot_Create_Ratio: 4,       //* The gap of last transaction price to create new slot. (unit : %, always minus value)
    new_slot_Create_Ratio_adj: 0, //* The adjustment ratio of new_slot_crcond. (unit : %, always minus value)
    new_addBidAsk_Create_Ratio: 20,       //* The gap of last transaction price to create new add_ask. (unit : %, always minus value)
    new_addBidAsk_Create_Ratio_adj: 0.1, //* The adjustment ratio of new_addbid_crcond. (unit : %, always minus value)
    restart_flag: 2,            // if flag != 0, set last_bidask_price = current price to restart trader when slot is empty.
    restart_base_price: 8300,            // ���� ��ܰ� ���� (��� 3 �̻��϶� ����)
    limit_invest_coin: 1000,    // The limitation of invest coin in current market. (unit : EA)
