...
// 4. Schema를 생성한다.
var ConfigParams_Schema = new mongoose.Schema(SchemaDefine);

// 5. statics methods 추가 가능 (핅요시)
/*
  Create : Document를 DB/Collection에 추가한다.
*/
ConfigParams_Schema.statics.insert = function (payload) {
  // this == Model
...
*/
ConfigParams_Schema.statics.findAll = function () {
  // this == Model
  return this.find({});
}
...
*/
ConfigParams_Schema.statics.query = function (option) {
  // this == Model
...
*/
ConfigParams_Schema.statics.deleteAll = function () {
  // this == Model
  //return this.remove({});
...
*/
ConfigParams_Schema.statics.delete = function (option) {
  // this == Model
  //return this.remove({});
...
/*
  Update : 
*/
ConfigParams_Schema.statics.update = function (option, payload) {
    // { returnNewDocument: true }: return the modified document rather than the original. defaults to false
    return this.findOneAndUpdate(option, payload, { returnNewDocument : true });
    //return this.UpdateMany(option, payload); 
}
...
/*
  Replace : 
*/
ConfigParams_Schema.statics.replace = function (option, payload) {
    return this.replaceOne(option, payload, { upsert : true });
}
...
*/
module.exports = mongoose.model(CollectionName, ConfigParams_Schema);
